################################################################################
# Combined Magma Gateway Dockerfile (Ubuntu 24.04)
################################################################################
...
# Fix library paths (avoid Bazel glob errors)
...
# Build Magma C external dependencies
RUN bazel build \
...
# Copy Magma source, Python env, and configs
...
# Copy OVS health scripts and entrypoint
